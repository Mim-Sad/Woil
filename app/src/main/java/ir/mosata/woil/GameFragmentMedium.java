...
public class GameFragmentMedium extends Fragment {

    private Button leftNumber, centerNumber, rightNumber, see_best, equal;
    ...
    private final int CENTER_BUTTON = 2;
...
//                        HiddenShot.getInstance().saveShot(getActivity(), myShot, "view");
        ...
        machTime.setText(getString(R.string.subtitle_challenge_mode_text) + " " + String.valueOf(timeOfGame) + " " + getString(R.string.subtitle_challenge_mode_time) + " " + getString(R.string.medium));
    ...
    private void findViews(View view) {
        ...
        centerNumber = (Button) view.findViewById(R.id.centerNumber);
    ...
    private void configureViews() {
        ...
        centerNumber.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (actionPermission == true) {
    ...
    private void generateNumber() {
        ...
        centerNumberInt = randomInt();
        rightNumberInt = randomInt();
        leftNumber.setText(String.valueOf(leftNumberInt));
        centerNumber.setText(String.valueOf(centerNumberInt));
    ...
    private void evaluate(int whatPressed) {
        ...
        boolean verge = (leftNumberInt == rightNumberInt && rightNumberInt == centerNumberInt);
        if (whatPressed == LEFT_BUTTON) {
            if (leftNumberInt >= rightNumberInt && leftNumberInt >= centerNumberInt && !verge) {
        ...
        } else if (whatPressed == CENTER_BUTTON) {
            if (centerNumberInt >= rightNumberInt && centerNumberInt >= leftNumberInt && !verge) {
                scoreInt += trueResponse;
                ai_dialog.setTextColor(getResources().getColor(R.color.green));
                ai_dialog.setText(trueBank[new Random().nextInt(trueBank.length)]);
                MainActivity.mepo.start();
            ...
            if (leftNumberInt <= rightNumberInt && centerNumberInt <= rightNumberInt && !verge) {
                scoreInt += trueResponse;
                ai_dialog.setTextColor(getResources().getColor(R.color.green));
                ai_dialog.setText(trueBank[new Random().nextInt(trueBank.length)]);
                MainActivity.mepo.start();
