...
public class GameFragmentEasy extends Fragment {

    private Button leftNumber, rightNumber, see_best, equal;
...
//                        HiddenShot.getInstance().saveShot(getActivity(), myShot, "view");
        ...
        machTime.setText(getString(R.string.subtitle_challenge_mode_text) + " " + String.valueOf(timeOfGame) + " " + getString(R.string.subtitle_challenge_mode_time) + " " + getString(R.string.easy));
...
//
//        Bitmap waterMark = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.wm_screenshot);
